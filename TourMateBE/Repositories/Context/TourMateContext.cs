    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Feedback>(entity =>
        {
            ...
            entity.HasOne(d => d.Invoice).WithMany(p => p.Feedbacks)
                ...
                .HasConstraintName("FK_feedback_invoice");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__FileStor__3213E83F8D7640D6");
        ...
        modelBuilder.Entity<Message>(entity =>
        {
            ...
            entity.HasOne(d => d.File).WithMany(p => p.Messages)
                ...
                .HasConstraintName("FKMessage541755");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E12F8971C29");
            ...
            entity.Property(e => e.ReceiverAccountId).HasColumnName("receiverAccountId");

            entity.HasOne(d => d.ReceiverAccount).WithMany(p => p.Notifications)
        ...
        modelBuilder.Entity<Revenue>(entity =>
        {
            ...
            entity.Property(e => e.ActualReceived)
                .HasColumnType("decimal(18, 2)")
                .HasColumnName("actualReceived");
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime")
                .HasColumnName("createdAt");
