...
public partial class TourmateContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Blog>(entity =>
        {
            ...
            entity.HasIndex(e => e.AccountId, "IX_Blog_accountId");
        ...
        modelBuilder.Entity<BlogComment>(entity =>
        {
            ...
            entity.HasIndex(e => e.AccountId, "IX_BlogComment_accountId");

            entity.HasIndex(e => e.BlogId, "IX_BlogComment_blogId");
        ...
        modelBuilder.Entity<BlogCommentReply>(entity =>
        {
            ...
            entity.HasIndex(e => e.AccountId, "IX_BlogCommentReply_accountId");

            entity.HasIndex(e => e.BlogCommentId, "IX_BlogCommentReply_blogCommentId");
        ...
        modelBuilder.Entity<BlogLike>(entity =>
        {
            ...
            entity.HasIndex(e => e.AccountId, "IX_BlogLike_accountId");

            entity.HasIndex(e => e.BlogId, "IX_BlogLike_blogId");
        ...
        modelBuilder.Entity<NewsCategory>(entity =>
        {
            ...
            entity.HasIndex(e => e.CategoryId, "IX_NewsCategory_categoryId");

            entity.HasIndex(e => e.NewsId, "IX_NewsCategory_newsId");
