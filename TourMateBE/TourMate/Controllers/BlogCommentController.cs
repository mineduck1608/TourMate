...
namespace API.Controllers
{
    ...
    public class BlogCommentController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<IEnumerable<BlogComment>> GetAll([FromQuery] int pageSize = 10, [FromQuery] int pageIndex = 1)
        {
            return Ok(_blogcommentService.GetAll(pageSize, pageIndex));
        }

        [HttpPost]
        public IActionResult Create([FromBody] BlogCommentCreateModel data)
        {
            var blogcomment = data.Convert();
        ...
        [HttpPut]
        public IActionResult Update([FromBody] BlogCommentCreateModel data)
        {
            var blogcomment = data.Convert();
