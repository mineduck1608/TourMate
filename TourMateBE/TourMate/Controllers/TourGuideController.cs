...
namespace API.Controllers
{
    ...
    public class TourGuideController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<IEnumerable<TourGuide>> GetAll([FromQuery] int pageSize = 10, [FromQuery] int pageIndex = 0)
        {
            return Ok(_tourguideService.GetAll(pageSize, pageIndex));
        }

        [HttpPost]
        public IActionResult Create([FromBody] TourGuide tourguide)
        {
        ...
        [HttpPut]
        public IActionResult Update([FromBody] TourGuide tourguide)
        {
            _tourguideService.UpdateTourGuide(tourguide);
            return NoContent();
        }
