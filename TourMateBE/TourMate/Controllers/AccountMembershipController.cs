...
namespace API.Controllers
{
    ...
    public class AccountMembershipController : ControllerBase
    {
        ...
        [HttpGet]
        public ActionResult<IEnumerable<AccountMembership>> GetAll([FromQuery] int pageSize = 10, [FromQuery] int pageIndex = 0)
        {
            return Ok(_accountmembershipService.GetAll(pageSize, pageIndex));
        }

        [HttpPost]
        public IActionResult Create([FromBody] AccountMembership accountmembership)
        {
        ...
        [HttpPut]
        public IActionResult Update([FromBody] AccountMembership accountmembership)
        {
