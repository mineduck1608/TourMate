...
namespace Services.Services
{
    ...
    {
        private IActiveAreaRepository ActiveAreaRepository;

        public ActiveAreaService(IActiveAreaRepository activeAreaRepository)
        {
            ActiveAreaRepository = activeAreaRepository;
        }
