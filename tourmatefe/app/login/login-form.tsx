...
export function LoginForm({
  ...
  async function handleGoogleLogin() {
    try {
      ...
      const decoded: MyJwtPayload | null = jwtDecode<MyJwtPayload>(response.accessToken.toString());
      ...
      <Card className="overflow-hidden">
        <CardContent className="grid p-0 md:grid-cols-2">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                <div className="mb-[-4] w-40 mt-[-15]">
                  <Link href="/">
                    <img src="/Logo.png" alt="TourMate Logo" className="w-full h-auto" />
                  </Link>
                </div>
              ...
              <Button onClick={handleGoogleLogin} variant="outline" className="w-full" disabled={loading} type="button">
          ...
          <div className="relative hidden bg-muted md:block">
            <img src="/vietnam-scene.jpg" alt="Image" className="absolute inset-0 h-full w-full object-cover dark:brightness-[0.2] dark:grayscale" />
          </div>
        </CardContent>
      </Card>
