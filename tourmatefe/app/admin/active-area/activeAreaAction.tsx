...
import {
  ...
  getActiveAreas,
  updateActiveArea,
} from "@/app/api/active-area.api";
import UpdateActiveAreaModal from "./updateActiveAreaModal";
import ActiveAreaDetailModal from "./activeAreaDetailModal";
...
const ActiveAreaActions: React.FC<ActiveAreaActionsProps> = ({ data }) => {
  ...
  const updateActiveAreaMutation = useMutation({
    mutationFn: ({ id, data }: { id: number; data: ActiveArea }) =>
      updateActiveArea(id, data),
    onSuccess: () => {
    ...
    <div>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem
            onClick={() => {
              setItemToDelete(data.areaId.toString());
              openDeleteModal();
            }}
          >
            Xóa
      ...
      {isDetailModalOpen && (
        <ActiveAreaDetailModal
          isOpen={isDetailModalOpen}
          onClose={closeDetailModal}
          currentActiveArea={data}
        />
      )}
    </div>
  );
