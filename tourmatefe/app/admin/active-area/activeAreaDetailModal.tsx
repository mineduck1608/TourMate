...
const ActiveAreaDetailModal: React.FC< ActiveAreaDetailsModalProps> = ({
  isOpen,
  onClose,
  currentActiveArea,
}) => {
  const [formData, setFormData] = useState<ActiveArea>(currentActiveArea);

  useEffect(() => {
    setFormData(currentActiveArea);
  }, [currentActiveArea]);
        ...
        <div className="flex flex-col gap-4 mb-4">
          ...
          <div>
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: formData.areaContent }}
            />
          </div>
        </div>
...
export default ActiveAreaDetailModal;
