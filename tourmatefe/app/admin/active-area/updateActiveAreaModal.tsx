...
type UpdateActiveAreaModalProps = {
  isOpen: boolean;
  onClose: () => void;
  currentData: ActiveArea;
  onSave: (data: ActiveArea) => void;
};

const UpdateActiveAreaModal: React.FC<UpdateActiveAreaModalProps> = ({
  isOpen,
  onClose,
  currentData,
  onSave,
...
export default UpdateActiveAreaModal;
