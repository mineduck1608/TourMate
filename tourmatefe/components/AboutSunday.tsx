      ...
      >
        ...
        <div className="relative z-10 max-w-screen mx-auto h-full grid md:grid-cols-2 grid-cols-1 gap-30 items-center px-6">
          ...
          <div className="text-white space-y-25 pr-4">
            <h2 className="text-4xl charm-regular">Thông tin về TourMate</h2>
            ...
            <a href="#" className="text-xs underline hover:text-gray-200 block">
              XEM THÊM
            </a>
          </div>
          ...
          <div className="bg-white/80 rounded-lg p-20 relative backdrop-blur-md mt-10 md:mt-0 mr-15">
            ...
            <div className="mt-10 text-center">
              <h3 className="charm-bold text-2xl">
                “Hành Trình Khám Phá kết nối Đam Mê”
              </h3>
              <p className="text-m text-gray-700 mt-10">
              ...
              <a
                href="#"
                className="inline-block text-sm mt-10 underline text-gray-600 hover:text-gray-500 "
              >
